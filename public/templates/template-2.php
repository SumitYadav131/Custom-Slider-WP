...
$facebook_link = get_post_meta($post_id, 'facebook-link', true);
$twitter_link = get_post_meta($post_id, 'twitter-link', true);
$instagram_link = get_post_meta($post_id, 'instagram-link', true);
    ...
    <div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel">
        ...
        <div class="hero-footer">
            <div class="hero-socials">
                <span><a href="<?php echo $facebook_link ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
